...
@section('content')
  ...
  <div class="container mt-4">
    <div class="d-flex justify-content-between mb-3">
      <h2 class="fw-bold">Edit Bus Type</h2>
        ...
        <form action="{{ route('admin.bus-types.update', $busType->id) }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="type_name" id="type_name"
                   ...
                   value="{{ old('type_name', $busType->type_name) }}" required>
          ...
          <div class="mb-3">
            ...
            <select name="deck_type" id="deck_type" class="form-select @error('deck_type') is-invalid @enderror" required>
              <option value="single" {{ old('deck_type', $busType->deck_type) == 'single' ? 'selected' : '' }}>Single</option>
              <option value="double" {{ old('deck_type', $busType->deck_type) == 'double' ? 'selected' : '' }}>Double</option>
            </select>
          ...
          <div class="mb-3">
            ...
            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                      rows="3">{{ old('description', $busType->description) }}</textarea>
