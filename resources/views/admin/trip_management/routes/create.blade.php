      ...
      <div class="card-body">
        <form action="{{ route('admin.routes.store') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="via" id="via" class="form-control @error('via') is-invalid @enderror" value="{{ old('via') }}">
            @error('via') <div class="invalid-feedback">{{ $message }}</div> @enderror
          </div>

          <div class="mb-3">
            <label for="distance_km" class="form-label">Distance (km)</label>
            <input type="number" step="0.01" name="distance_km" id="distance_km" class="form-control @error('distance_km') is-invalid @enderror" value="{{ old('distance_km') }}" required>
          ...
          <div class="mb-3">
            ...
            <input type="number" name="duration_min" id="duration_min" class="form-control @error('duration_min') is-invalid @enderror" value="{{ old('duration_min') }}" required>
