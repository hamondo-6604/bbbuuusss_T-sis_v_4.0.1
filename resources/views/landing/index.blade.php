                        ...
                        <div class="search_tabs_container">
                            <div
                                ...
                                @foreach ($tabs as $index => $tab)
                                    <div
                                        class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start {{ $loop->first ? 'active' : '' }}">
                                        <img src="{{ asset('assets/landing/images/' . $tab['icon']) }}"
                                            alt="">
                                        <span>{{ $tab['label'] }}</span>
                                    </div>
                                @endforeach
                        ...
                        @foreach ($tabs as $index => $tab)
                            <div class="search_panel {{ $loop->first ? 'active' : '' }}">
                                <form action="#" id="search_form_{{ $loop->iteration }}"
                                    ...
                                    <div class="search_item">
                                        <div>adults</div>
                                        <select name="adults" id="adults_{{ $loop->iteration }}"
                                    ...
                                    <div class="search_item">
                                        <div>children</div>
                                        <select name="children" id="children_{{ $loop->iteration }}"
                                            class="dropdown_item_select search_input">
                                            <option>0</option>
                                            <option>02</option>
                                            <option>03</option>
                        ...
                        <div class="col-lg-4 intro_col">
                            <div class="intro_item">
                                ...
                                <div class="intro_item_background"
                                    style="background-image:url('{{ asset('assets/landing/images/' . $intro['img']) }}')">
                                </div>
                                <div
                                            ...
                                            <div class="offers_icons">
                                                <ul class="offers_icons_list">
                                                    <li class="offers_icons_item"><img
                                                            src="{{ asset('assets/landing/images/post.png') }}"
                                                            alt=""></li>
                                                    <li class="offers_icons_item"><img
                                                            src="{{ asset('assets/landing/images/compass.png') }}"
                                                            alt=""></li>
                                                    <li class="offers_icons_item"><img
                                                            src="{{ asset('assets/landing/images/bicycle.png') }}"
                                                            alt=""></li>
                                                    <li class="offers_icons_item"><img
                                                            src="{{ asset('assets/landing/images/sailboat.png') }}"
                                                            alt=""></li>
                                                </ul>
                                            </div>
                    ...
                    <div class="col">
                        ...
                        <div class="test_slider_container">
                                ...
                                @php
                                    $testimonials = [
                                        ...
                                        [
                                            ...
                                            'text' =>
                                                'Suspendisse potenti. Curabitur blandit tempus porttitor. Integer posuere erat a ante venenatis dapibus posuere velit aliquet.',
                                        ],
                                        [
                                            'image' => 'test_3.jpg',
                                            'icon' => 'kayak.png',
                                    ...
                                    <div class="owl-item">
                                        <div class="test_item">
                                            <div class="test_image">
                                                <img src="{{ asset('assets/landing/images/' . $test['image']) }}"
                                                    alt="{{ $test['name'] }}">
                                            </div>
                                            <div class="test_icon">
                                                <img src="{{ asset('assets/landing/images/' . $test['icon']) }}"
                                                    alt="">
                                            </div>
                            ...
                            <div class="test_slider_nav test_slider_prev">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="28px" height="33px"
                                    viewBox="0 0 28 33">
                                    <defs>
                    ...
                    <div class="col-lg-7">
                        <div class="contact_form_container">
                            ...
                            <form action="#" id="contact_form" class="contact_form">
                                ...
                                <input type="text" id="contact_form_subject"
                            ...
                            <div class="footer_content footer_blog">
                                ...
                                <div class="footer_blog_item clearfix">
                                    ...
                                    <div class="footer_blog_content">
                                        <div class="footer_blog_title"><a href="blog.html">Travel with us this
                                                year</a>
                                        </div>
                                ...
                                <div class="footer_blog_item clearfix">
                                    ...
                                    <div class="footer_blog_content">
                                        <div class="footer_blog_title"><a href="blog.html">New destinations for
                                                you</a>
                                        </div>
                                        <div class="footer_blog_date">Nov 29, 2017</div>
                                    </div>
                            ...
                            <div class="footer_content footer_contact">
                                <ul class="contact_info_list">
                                    <li class="contact_info_item d-flex flex-row">
                                        <div>
                                            <div class="contact_info_icon"><img src="images/placeholder.svg"
                                                    alt=""></div>
                                        </div>
                                    ...
                                    <li class="contact_info_item d-flex flex-row">
                                        <div>
                                            <div class="contact_info_icon"><img src="images/phone-call.svg"
                                                    alt=""></div>
                                        </div>
                                    ...
                                    <li class="contact_info_item d-flex flex-row">
                                        <div>
                                            <div class="contact_info_icon"><img src="images/message.svg"
                                                    alt="">
                                            </div>
                                        </div>
                                    ...
                                    <li class="contact_info_item d-flex flex-row">
                                        ...
                                        <div class="contact_info_text"><a
                                                href="https://colorlib.com">www.colorlib.com</a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
